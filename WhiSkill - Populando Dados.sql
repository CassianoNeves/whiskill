...
INSERT  INTO SKILLCOLABORADOR(IDSkill, IDColaborador) VALUES(SELECT IDSKILL FROM SKILL WHERE Nome LIKE 'Java', SELECT IDCOLABORADOR FROM COLABORADOR WHERE NOME LIKE 'Paula%');
